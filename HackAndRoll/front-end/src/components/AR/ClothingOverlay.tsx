    ...
    useEffect(() => {
      ...
      if (torso && torso.score > 0.5 && clothingImage) {
        ...
        // img.onload = () => {
          ...
          const x = (torso.x * scaleX) - (imgWidth / 2) - 230;
          const y = (torso.y * scaleY) - (imgHeight / 2) + 280;
