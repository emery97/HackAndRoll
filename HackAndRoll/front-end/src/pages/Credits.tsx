    ...
    <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark w-full h-full flex flex-col cursor-pointer">
      <div className="flex flex-col flex-grow">
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
          Chioset - Click, Style, Slay. A virtual fitting room that helps you find the perfect outfit for any occasion. Simply scan your closet, and let our AI stylist do the rest. Want to try it your clothes? Simply go to "Your Closet" and click on the item you want to try on. It's that easy!
        </p>
